        ...
        <section id='herosection' className=' top-0 bg-custom-gradient  relative  pt-32'>
            ...
            <div className=' relative overflow-hidden'>
                ...
                <motion.div
                    ...
                    <a href={data.herosection.buttonslinks.appstore} className='z-30 w-full sm:w-auto text-base text-center font-semibold px-10 py-3  p-3 rounded-full border border-black bg-gradient-to-r from-[#6ACE57] to-[#07C8E6]  hover:from-[#07C8E6] hover:to-[#6ACE57] active:from-[#6ACE57] active:to-[#07C8E6] transition-all text-black ease-out duration-300   flex gap-3 items-center justify-center'><icons.appleicon></icons.appleicon> Get it on App Store</a>
                    <a href={data.herosection.buttonslinks.playstore} className=' z-30 w-full sm:w-auto text-base text-center text-black font-semibold px-10 py-3  p-3 rounded-full border border-black bg-white  flex gap-3 items-center hover:bg-white/90  transition-all ease-out duration-300 justify-center'>
