...
export default function Footer() {
  return (
    <section className=' px-20 py-10'>
      <div className=' flex justify-between items-center w-full max-w-7xl mx-auto px-2 pb-6 '>
        <div>
      ...
      <div className=' flex justify-between items-center w-full max-w-7xl mx-auto  pt-5 border-t  '>
