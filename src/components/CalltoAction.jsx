    ...
    <section className=' relative overflow-hidden bg-[#232526]'>
      <div className='  flex flex-col gap-6 text-white bg-[#232526] my-36 lg:my-24 '>
        ...
        <div className=' flex flex-col px-6 sm:px-0  sm:flex-row z-30 justify-center items-center text-black gap-4 mt-[3.2rem]'>
          <a href={data.herosection.buttonslinks.sighup} className='z-30 text-base text-center w-full sm:w-auto font-semibold px-10 py-3  p-3 rounded-full border border-black bg-gradient-to-r from-[#6ACE57] to-[#07C8E6]'>Sign Up Now</a>
          <a href={data.herosection.buttonslinks.learnmore} className=' z-30 text-base text-center w-full sm:w-auto font-semibold px-10 py-3  p-3 rounded-full border  border-black bg-white'>Learn More </a>
        </div>
      </div>
