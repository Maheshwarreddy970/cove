  ...
  return (
    <section>
      <div className=' flex flex-col items-center gap-1'>
        ...
        <h1 className=' text-[2.5rem] font-bold leading-[3rem] lg:text-[46px] lg:leading-[55.2px] tracking-[-0.02em] text-center decoration-skip-ink-none text-[#171717]'>{data.gettoknowussection.heading}</h1>
      ...
      <div className='flex flex-col lg:flex-row px-4 gap-10 max-w-[77rem] mx-auto mt-14'>
        <div className=' w-full lg:w-[65%]  p-[1.5rem] flex flex-col gap-[1.5rem] bg-[#F6F6E9] rounded-3xl'>
