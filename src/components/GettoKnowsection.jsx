...
export default function GettoKnowsection() {
  return (
    <section>
      ...
      <div className=' grid grid-cols-3 gap-10 max-w-[77rem] mx-auto mt-14'>
        <div className=' col-span-2  p-[1.5rem] flex flex-col gap-[1.5rem] bg-[#F6F6E9] rounded-3xl'>
        ...
        <div className=' flex justify-center items-center bg-gradient-to-br from-[#7ACF3F] to-[#00C8F0] rounded-3xl '>
