...
export default function OldNew() {
  return (
    <section id='beforeaftersection' className='  max-w-7xl xl:mx-auto mt-24 sm:mt-32 px-4 xl:px-0 pb-16 '>
      <Smoothup className=' flex flex-col items-center gap-3 text-[#171717] dark:text-white'>
      ...
      <div className=' grid grid-cols-1 md:grid-cols-2 gap-8 mt-14'>
        <Smoothup delay={0.3} className='rounded-[0.75rem] overflow-hidden relative border pt-6 pr-10 pb-6 pl-10 gap-6 bg-[#F6F6E9] border-[#D0D0BB] text-[#171717] dark:text-white dark:bg-white/5 dark:border-white/20 w-full h-[600px] lg:h-[540px] border-t'>
        ...
        <Smoothup delay={0.3} className='rounded-[0.75rem] overflow-hidden relative border pt-6 pr-10 pb-6 pl-10 gap-6 bg-gradient-to-br from-[#C8FFBE] to-[#5CBCCB] border-[#79B487] w-full h-[600px] lg:h-[540px] border-t'>
