...
export default function Logosection() {
    return (
        <section className=' mt-[14rem] sm:mt-[26rem] max-w-4xl mx-auto'>
            ...
            <div className="lg:grid flex p-3 flex-wrap items-center justify-center place-items-center text-[#6C6C6C] dark:text-white opacity-65 gap-7 md:gap-[100px] lg:grid-cols-5">
